...
import { ArrowRight, Facebook, Loader2, Lock, Mail } from "lucide-react";
      ...
      <div className="container max-w-lg">
        <Card className="rounded-3xl border-0 bg-white/90 shadow-[0_20px_60px_rgba(15,23,42,0.12)] backdrop-blur transition-all duration-300 hover:shadow-[0_26px_70px_rgba(15,23,42,0.16)]">
          <CardHeader>
            ...
            <CardDescription>Login to manage your profile, bookings, and nearby shops.</CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
            ...
            <Button
              className="w-full h-12 bg-[rgb(30,190,118)] hover:bg-[rgb(26,168,104)] text-white transition-all duration-200"
              onClick={onSubmit}
